<?php /*a:1:{s:68:"/www/wwwroot/mmo.jrytc.cn/application/manage/view/kefu/kefu_add.html";i:1660982655;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
					...
					<form class="layui-form layui-form-pane" action="">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="kefu_url" autocomplete="off" placeholder="请输入客服链接" class="layui-input">
							</div>
						</div>
