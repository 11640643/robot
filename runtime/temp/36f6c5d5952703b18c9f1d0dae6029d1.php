<?php /*a:1:{s:81:"D:\phpstudy_pro\WWW\miningMachineOne\application\manage\view\base\admins_add.html";i:1654065898;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <form class="layui-form layui-form-pane" action="">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="username" autocomplete="off" placeholder="请输入成员账号" class="layui-input">
                                </div>
                            ...
                            <div class="layui-form-item" style="margin-top: 40px;text-align: center;">
                                <div class="layui-input-block">
                                    <button class="layui-btn" lay-submit lay-filter="admins_add_do">立即提交</button>
