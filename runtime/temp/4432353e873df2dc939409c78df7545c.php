<?php /*a:1:{s:75:"/www/wwwroot/robot.jrytc.cn/application/manage/view/pledge/pledge_list.html";i:1661660451;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    layui.use(['table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field: 'amount', title: '质押金额', sort: true, totalRow: true}
                ,{field: 'start_time', title: '质押开始时间' }
                ,{field: 'day', title: '质押周期/天', sort: true, }
                ,{field: 'pledge_income', title: '质押收益', sort: true, }
                ,{field: 'end_time', title: '质押结束时间', sort: true, }
                ,{field: 'status', title: '质押状态', sort: true, }
