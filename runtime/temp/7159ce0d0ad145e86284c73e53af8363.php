<?php /*a:1:{s:80:"D:\phpstudy_pro\WWW\miningMachineOne\application\manage\view\base\popup_add.html";i:1660833865;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
					...
					<form class="layui-form layui-form-pane" action="">
						...
						<div class="layui-form-item">
							<div class="layui-upload">
								<button type="button" class="layui-btn" id="popup-update">图片上传</button>
								<blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
									预览图：
									<div class="layui-upload-list" id="popup-preview"></div>
								</blockquote>
							</div>
						</div>
						<div class="layui-form-item" style="margin-top: 40px;text-align: center;">
							<div class="layui-input-block">
								<button class="layui-btn" lay-submit lay-filter="popupList" data-suburi="popupAdd">立即提交</button>
