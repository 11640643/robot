<?php /*a:1:{s:78:"/www/wwwroot/robot.jrytc.cn/application/manage/view/users/user_level_edit.html";i:1661243034;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <form class="layui-form" action="">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="name" value="<?php echo htmlentities($data['name']); ?>" autocomplete="off" placeholder="请输入等级名称" class="layui-input">
                                </div>
                            </div>
                            <!--<div class="layui-form-item">-->
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="amount" value="<?php echo htmlentities($data['amount']); ?>" autocomplete="off" placeholder="升级所需" class="layui-input">
                                </div>
