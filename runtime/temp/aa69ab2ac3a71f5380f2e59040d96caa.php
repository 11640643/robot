<?php /*a:1:{s:88:"D:\phpstudy_pro\WWW\miningMachineOne\application\manage\view\users\recharge_dispose.html";i:1642754578;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="layui-card">
                    <div class="layui-card-body">
                        <form class="layui-form" action="">
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label">哈希地址</label>
                                <div class="layui-input-inline">
                                    <input readonly="readonly" type="text" name="hash" value="<?php echo htmlentities($data['hash']); ?>" value="" autocomplete="off" placeholder="" class="layui-input" >
                                </div>
                                <div class="layui-form-mid layui-word-aux"></div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="radio" name="state" value="1" title="通过"<?php if($data['state'] == 1): ?> checked<?php endif; ?>>
                                    <input type="radio" name="state" value="2" title="驳回"<?php if($data['state'] == 2): ?> checked<?php endif; ?>>
