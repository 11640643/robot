<?php /*a:1:{s:68:"/www/wwwroot/robot.jrytc.cn/application/manage/view/index/index.html";i:1661434793;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
            ...
            <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                ...
                <li data-name="" class="layui-nav-item"><!-- layui-nav-itemed -->
                    <a href="javascript:;" lay-tips="/manage/<?php echo htmlentities($value['role_name']); ?>" lay-direction="2">
                        <i class="layui-icon
                        <?php switch($value['role_id']): case "1": ?>layui-icon-set<?php break; case "2": ?>layui-icon-user<?php break; case "3": ?>layui-icon-rmb<?php break; case "4": ?>layui-icon-list<?php break; case "5": ?>layui-icon-chart-screen<?php break; case "7": ?>layui-icon-read<?php break; case "255": ?>layui-icon-group<?php break; case "331": ?>layui-icon-senior<?php break; case "389": ?>layui-icon-rmb<?php break; ?>
                        <?php endswitch; ?>"></i>
