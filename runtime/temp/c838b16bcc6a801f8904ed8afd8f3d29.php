<?php /*a:1:{s:86:"D:\phpstudy_pro\WWW\miningMachineOne\application\manage\view\users\user_level_add.html";i:1642754580;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <form class="layui-form" action="">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="name" autocomplete="off" placeholder="请输入英文等级名称" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="amount" autocomplete="off" placeholder="请输入购买金额" class="layui-input">
                                </div>
