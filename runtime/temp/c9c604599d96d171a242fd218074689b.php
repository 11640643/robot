<?php /*a:1:{s:80:"D:\phpstudy_pro\WWW\miningMachineOne\application\manage\view\base\slide_add.html";i:1660807509;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<!--                            </div>-->
                            ...
                            <div class="layui-form-item">
                                <div class="layui-upload">
                                    <button type="button" class="layui-btn" id="slide-update">图片上传</button>
                            ...
                            <div class="layui-form-item" style="margin-top: 40px;text-align: center;">
                                <div class="layui-input-block">
                                    <button class="layui-btn" lay-submit lay-filter="slideList" data-suburi="slideAdd">立即提交</button>
