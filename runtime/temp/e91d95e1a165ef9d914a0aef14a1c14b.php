<?php /*a:1:{s:81:"D:\phpstudy_pro\WWW\miningMachineOne\application\manage\view\bet\product_add.html";i:1653140382;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <form class="layui-form" action="">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    ...
                                    <input type="radio" name="vip_level" value="<?php echo htmlentities($value['grade']); ?>" title="<?php echo htmlentities($value['name']); ?>"<?php if(reset($userLevel) == $value): ?> checked<?php endif; ?>>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                            <div class="layui-form-item">
