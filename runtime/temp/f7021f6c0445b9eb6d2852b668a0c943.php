<?php /*a:1:{s:81:"D:\phpstudy_pro\WWW\miningMachineOne\application\manage\view\base\popup_list.html";i:1660896877;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	<title>首页弹出图片管理</title>
	...
	<div class="layui-row layui-col-space15">
		<div class="layui-col-md12">
			<div class="layui-card">
				<table class="layui-hide" id="popupList" lay-filter="popupList"></table>
			</div>
		</div>
	</div>
</div>
...
<script src="/resource/js/manage/popup.js"></script>
<script>
	layui.use(['table','layer'], function(){
		...
		//监听排序事件
		table.on('sort(popupList)', function(obj){ //注：sort 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
			//尽管我们的 table 自带排序功能，但并没有请求服务端。
			//有些时候，你可能需要根据当前排序的字段，重新向服务端发送请求，从而实现服务端排序，如：
			table.reload('popupList', {
